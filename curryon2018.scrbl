...
@title[#:tag "curryon2018" #:style 'unnumbered]{@hyperlink["http://www.curry-on.org/2018/sessions/distributed-systems-protocols-and-their-vulnerabilities.html"]{Curry On, Amsterdam}}

@centered{-------@bold{Distributed Systems Protocols and their Vulnerabilities}-------}

@centered{Conference: @hyperlink["http://www.curry-on.org/2018/"]{Curry On Conf}}
@centered{
...
@hyperlink["https://twitter.com/curry_on_conf"]{CurryOnConf Twitter}
...
@hyperlink["https://www.youtube.com/watch?v=Gi1yrW8_EPk&t=0s&list=PLLYi1o1pORgNRq6l5Ude2tb1HaIzvnkdB&index=11"]{@image["./pics/curryon-talk.png"]}
